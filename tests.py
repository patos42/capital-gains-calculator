...
class CapitalGainsTaxTests(TestCase):
    def test_capital_gains(self) -> None:
        trade1 : TaxableTrade = TaxableTrade(Trade("BHP", datetime(2019, 1, 1), 10, "AUD",12, Amount(0, "AUD")), 10,1, 0)
        trade2: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2020, 1, 3), 12, "AUD", -12, Amount(0, "AUD")),12,1, 0)
        trade3: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2020, 1, 1), 10, "AUD", 12, Amount(0, "AUD")), 10, 1, 0)
        trade4: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2020, 1, 3), 12, "AUD", -12, Amount(0, "AUD")), 12, 1, 0)
    ...
    def test_commission(self) -> None:
        trade1: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2019, 1, 1), 10, "AUD",100, Amount(-30, "AUD")), 10, 1, -30)
        trade2: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2020, 1, 3), 12, "AUD", -100, Amount(-50, "AUD")), 12, 1, -50)
        trade3: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2020, 1, 1), 10, "AUD", 100, Amount(-20, "AUD")), 10, 1, -20)
    ...
    def test_partial_match_commission(self) -> None:
        trade1: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2019, 1, 1), 10, "AUD", 100, Amount(-30, "AUD")), 10, 1, -30)
        trade2: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2020, 1, 3), 12, "AUD", -50, Amount(-50, "AUD")), 12, 1, -50)
        trade3: TaxableTrade = TaxableTrade(Trade("BHP", datetime(2020, 1, 1), 12, "AUD", -50, Amount(-20, "AUD")), 12, 1, -20)
    ...
    def test_fx_capital_gains(self) -> None:
        trade1: TaxableTrade = TaxableTrade(Trade("USD.AUD", datetime(2019, 1, 1), 0.5, "AUD",100, Amount(0, "AUD")), 0.5, 0.5, 0)
        trade2: TaxableTrade = TaxableTrade(Trade("USD.AUD", datetime(2020, 1, 3), 1, "AUD", -100, Amount(0, "AUD")), 1, 1, 0)
        trade3: TaxableTrade = TaxableTrade(Trade("USD.AUD", datetime(2019, 1, 1), 1, "AUD", 100, Amount(0, "AUD")), 1, 1, 0)
        trade4: TaxableTrade = TaxableTrade(Trade("USD.AUD", datetime(2019, 1, 3), 0.5, "AUD", -100, Amount(0, "AUD")), 0.5, 0.5, 0)
