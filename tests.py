...
class FifoInventoryTests(TestCase):
    def test_basic(self):
        trades: List[Trade] = []
        trades.append(Trade("BHP", datetime(2020, 1, 1), 10, 32))
        trades.append(Trade("BHP", datetime(2020, 2, 1), 10, -32))
    ...
    def test_sold_in_two(self):
        trades: List[Trade] = []
        trades.append(Trade("BHP", datetime(2020, 1, 1), 10, 32))
        trades.append(Trade("BHP", datetime(2020, 2, 1), 11, -16))
        trades.append(Trade("BHP", datetime(2020, 3, 1), 12, -16))
    ...
    def test_bought_in_two(self):
        trades: List[Trade] = []
        trades.append(Trade("BHP", datetime(2020, 1, 1), 10, -32))
        trades.append(Trade("BHP", datetime(2020, 2, 1), 20, 16))
        trades.append(Trade("BHP", datetime(2020, 3, 1), 20, 16))
    ...
    def test_bought_in_two_sold_in_one(self):
        trades: List[Trade] = []
        trades.append(Trade("BHP", datetime(2020, 1, 1), 10, 16))
        trades.append(Trade("BHP", datetime(2020, 2, 1), 10, 16))
        trades.append(Trade("BHP", datetime(2020, 3, 1), 10, -32))
    ...
    def test_complex_profile(self):
        trades: List[Trade] = []
        trades.append(Trade("BHP", datetime(2020, 1, 1), 10, 12))
        trades.append(Trade("BHP", datetime(2020, 1, 2), 11, 12))  # Inventory: 24
        trades.append(Trade("BHP", datetime(2020, 1, 3), 12,
                            -14))  # Inventory 10, 12 Sold @ base cost $10, 2 Sold @ $11.
        trades.append(Trade("BHP", datetime(2020, 1, 4), 13, -12))  # Inventory -2; 10 sold @ base cost $11.
        trades.append(
            Trade("BHP", datetime(2020, 1, 5), 14, 10))  # Inventory 8; 2 bought/closed @ base cost $13
